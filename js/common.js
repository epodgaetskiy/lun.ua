...
function getCountries() {
	...
	xhr.open('GET', 'date/countries.json'); //Загрузка данных из файла date/countries.json по XMLHttpRequest.
...
function getCities() {
	...
	xhr.open('GET', 'date/cities.json'); //Загрузка данных из файла date/countries.json по XMLHttpRequest.
